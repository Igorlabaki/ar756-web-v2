...
export default function FaqItemList({ item }: FaqItemListProps) {
  ...
  return (
    <div
      className={`shadow-lg border-[0.5px] border-black/25 rounded-md py-2 px-2 flex flex-col gap-y-2 space-x-2 w-full ${isQuestionOpen ? " h-auto" :  " h-[40px]"} duration-300`}
      key={item.id}
    >
